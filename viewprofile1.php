            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Setting <small>Profile</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-wrench"></i> View Profile
                            </li>
                        </ol>
                    </div>
                </div>
			    ...
			    <div class="row">
                  ...
                  <div class="alert alert-success">
                    <strong>View and Edit Your Account!</strong>
...
$query = "SELECT * FROM user_registration WHERE password='$password' AND email='$email' ";
  ...
  if(! $retval )
   ...
   {
	  echo"Admin ID: {$row['userID']} <br> ".
	  	  "Fullname: {$row['Name']} <br> ".
		  "Admin Name: {$row['userName']} <br> ".
...
<p><a href="changepassword1.php" class="btn btn-sm btn-success">Change Password</a>
<a href="index.php" class="btn btn-sm btn-info">Back</a></p>
				</div>
                </div>
                <!-- /.row -->
