                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Report <small>Report Review</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
...
$db=mysql_select_db(DB_NAME,$con) or die("Failed to connect to MySQL: " . mysql_error());
	  ...
	  $query = mysql_query("SELECT SUM(total_sales),MONTHNAME(datetime) FROM sales GROUP BY MONTHNAME(datetime)") or die(mysql_error());?>
                           ...
                           <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
								  ...
								  while($row = mysql_fetch_assoc($query)){?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "{$row['SUM(total_sales)']}"?></td>
                                        <td><?php echo "{$row['MONTHNAME(datetime)']}\n;"?></td>
                            ...
                            <p align="right">
                            <a href="pdf2.php" class="btn btn-sm btn-default" target="_blank"><i class="fa fa-print">Print</i></a>
