            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Inventory <small>Add Product</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-wrench"></i> Inventory                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                  ...
                  <div class="alert alert-warning">
                    <strong>Opps!</strong> The book had added in the list!
                </div> 
 
 						<legend>Press back to the preview page</legend> 
