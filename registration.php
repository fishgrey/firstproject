            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Registration <small>Manager or Worker</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-wrench"></i> Signup                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                  ...
                  <div class="alert alert-success">
                    <strong>Sign Up!</strong> Please click on the correct position that you have been assigned!
                </div> 
 
 						<legend>Please Choose either manager or worker</legend> 
 
 							<a href="signup.php"><img src="img/manager.png"></a>
						 	<a href="signup1.php"><img src="img/employee.png"></a>
