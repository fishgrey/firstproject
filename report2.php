        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Report <small>View Report</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                            	<i class="fa fa-book"></i> Book in Stock
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div class="alert alert-info">
                    <strong>Check Report!</strong> Book Remain in Stock.
                    </div>
                </div>
                </div>
                <!-- /.row -->
...
$db=mysql_select_db(DB_NAME,$con) or die("Failed to connect to MySQL: " . mysql_error());
	  ...
	  $query = mysql_query("SELECT * FROM book WHERE book_quantity !=0 LIMIT 0,11") or die(mysql_error());?>
                           ...
                           <table class="table table-bordered table-hover table-striped">
                            ...
                            <p align="right">
                            <a href="pdf1.php" class="btn btn-sm btn-default" target="_blank"><i class="fa fa-print">Print</i></a>
                            <a href="report.php" class="btn btn-sm btn-info">Back</a>
                            </p>
                            <nav>
  							<ul class="pager">
   							  <li><a href="#">Previous</a></li>
  							  <li><a href="report4.php">Next</a></li>
							</ul>
							</nav>
