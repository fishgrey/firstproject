...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Report <small>Sort By Total Sales</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
	  ...
	  $totalsales1 = $_GET['total_sales1'];
	  $query = mysql_query("SELECT * FROM sales WHERE total_sales BETWEEN '$totalsales' AND '$totalsales1' ORDER BY datetime ASC")or die(mysql_error());   ?>
                 <div class="row">
                    <div class="col-lg-12">
                    <div class="alert alert-info">
                    The books' price between<strong>RM <?php echo "{$totalsales}" ?></strong> to <strong>RM <?php echo "{$totalsales1}"?> </strong> .
                </div>
