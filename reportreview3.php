...
$db=mysql_select_db(DB_NAME,$con) or die("Failed to connect to MySQL: " . mysql_error());
	  ...
	  $query = mysql_query("SELECT COUNT(salesID) AS tol,MONTHNAME(datetime) FROM sales GROUP BY MONTHNAME(datetime)") or die(mysql_error());?>
                           ...
                           <table class="table table-bordered table-hover table-striped">
                            ...
                            <p align="right">
                            <a href="pdf3.php" class="btn btn-sm btn-default" target="_blank"><i class="fa fa-print">Print</i></a>
