...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Report <small>Sort By Book Price</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
	  ...
	  $price = $_GET['price'];
	  $price1 = $_GET['price1'];
	  $query = mysql_query("SELECT * FROM book WHERE price BETWEEN '$price' AND '$price1' ORDER BY datetime ASC")or die(mysql_error());   ?>
                 <div class="row">
                    <div class="col-lg-12">
                    <div class="alert alert-info">
                    The books' price between<strong>RM <?php echo "{$price}" ?></strong> to <strong>RM <?php echo "{$price1}"?> </strong> .
                </div>
