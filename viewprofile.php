...
$query = "SELECT * FROM admin_registration WHERE password='$password' AND email='$email' ";
...
<p><a href="changepassword.php" class="btn btn-sm btn-success">Change Password</a>
