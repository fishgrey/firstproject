...
<head>
    ...
    <title>Evergreen Bookstore Inventory Management ---Manager Login</title>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <input class="form-control" type="password" name="password"><br> <p>Do not have an account?<a href="registration.php" class="btn btn-sm btn-link">Sign Up here!</a></p>
