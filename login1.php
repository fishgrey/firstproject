...
<head>
    ...
    <title>Evergreen Bookstore Inventory Management ---Worker Login</title>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="profile.com">View Profile</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Login <small>Worker</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-wrench"></i> Login                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="col-lg-6">
                 ...
                 <p>Do not have an account?<a href="registration.php" class="btn btn-sm btn-link">Sign Up!</a></p>
                 <input class="btn btn-primary" id="button" type="submit" name="submit" value="Login">
 				 </form>
				 </div>
