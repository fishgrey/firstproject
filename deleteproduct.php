        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Inventory <small>Delete Products</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <!-- /.row -->
                 <div class="row">
                    <div class="col-lg-6">
                <form role="form" method="POST" action="connection_deleteproduct.php">
                <div class="form-group">
                          ...
                          <p>  
                          <input id="button" class="btn btn-sm btn-danger" type="submit" name="submit" value="Delete">
