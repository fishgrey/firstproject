...
<head>
    ...
    <title>Evergreen Bookstore Inventory Management ---Login</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li>
                	<a href="#" class="btn btn-sm btn-link">Login</a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Login <small>Manager or Worker</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-wrench"></i> Sign-in                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                  ...
                  <div class="alert alert-success">
                    <strong>Login!</strong> Please click on the correct position that you have been assigned!
                </div> 
 
 						<legend>Please Choose either manager or worker</legend> 
 
 							<a href="login.php"><img src="img/manager.png"></a>
						 	<a href="login1.php"><img src="img/employee.png"></a>
