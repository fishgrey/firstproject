...
<head>
    ...
    <title>Evergreen Bookstore Inventory Management -- Update Sales</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Evergreen Bookstore Inventory Management</a>
            </div>
            <!-- Top Menu Items -->
...
$db=mysql_select_db(DB_NAME,$con) or die("Failed to connect to MySQL: " . mysql_error());
	  ...
	  $query = mysql_query("SELECT salesID,bookID,bookName,price,quantity FROM sales WHERE salesID='$salesID' ")or die(mysql_error()); 
	  ...
	  ?>
                <div class="row">
                    <div class="col-lg-6">
				<form role="form" method="POST" action="connection_updatesales.php">
                <div class="form-group">
                                <label>SalesID</label>
                                <input type="text" class="form-control" name="salesID" value="<?php echo$row['salesID'];?>">
                                 <label>BookID</label>
                                <input type="text" class="form-control" name="bookID" value="<?php echo$row['bookID'];?>">
                                <label>Book Name</label>
                                <input type="text" class="form-control" name="bookName" value="<?php echo$row['bookName'];?>">               
                                <label>Price</label>
                                <input type="text" class="form-control" name="price" value="<?php echo$row['price'];?>">
                                 <label>Quantity</label>
                                <select type="text" class="form-control" name="quantity" value="<?php echo$row['quantity'];?>">
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
