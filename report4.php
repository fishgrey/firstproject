...
$db=mysql_select_db(DB_NAME,$con) or die("Failed to connect to MySQL: " . mysql_error());
	  ...
	  $query = mysql_query("SELECT * FROM book WHERE book_quantity !=0 LIMIT 11,21") or die(mysql_error());?>
                           ...
                           <table class="table table-bordered table-hover table-striped">
                            ...
                            <p align="right">
                            <a href="pdf1.php" class="btn btn-sm btn-default"><i class="fa fa-print">Print</i></a>
                            <a href="report.php" class="btn btn-sm btn-info">Back</a>
                            </p>
                            <nav>
  							<ul class="pager">
   							  <li><a href="report2.php">Previous</a></li>
  							  <li><a href="#">Next</a></li>
							</ul>
							</nav>
