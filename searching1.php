...
<head>
    ...
    <title>Evergreen Bookstore Inventory Management ---Check Stock</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Inventory <small>Search Product</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        </div><a href="searching.html" class="btn btn-sm btn-info">Back</a>
                    </div>
