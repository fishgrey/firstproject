...
<body>
    ...
    <div id="wrapper">
	  ...
	  $datetime1 = $_GET['datetime1'];
	  $query = mysql_query("SELECT * FROM sales WHERE datetime BETWEEN 'datetime' AND 'datetime1' ORDER BY datetime ASC")or die(mysql_error());   ?>
                 <div class="row">
                    <div class="col-lg-12">
                    <div class="alert alert-info">
                    The sales between<strong> <?php echo "{$datetime}" ?></strong> to <strong><?php echo "{$datetime1}"?></strong> .
                </div>
...
?><p><a href="sales1.php" class="btn btn-sm btn-info">Back</a></p>
                </div>
                    </div>
                <!-- /.row -->
