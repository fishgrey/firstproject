...
<body>
    ...
    <div id="wrapper">
	  ...
	  $date = $_GET['datetime'];
	  $date1 = $_GET['datetime1'];
	  $query = mysql_query("SELECT * FROM book WHERE datetime  BETWEEN '$date' AND '$date1' ORDER BY datetime ASC")or die(mysql_error());   ?>
                 <div class="row">
                    <div class="col-lg-12">
                    <div class="alert alert-info">
                    The book between<strong> <?php echo "{$date}" ?></strong> to <strong><?php echo "{$date1}"?></strong> .
                </div>
...
?><p><a href="inventory1.php" class="btn btn-sm btn-info">Back</a></p>
                </div>
                    </div>
                <!-- /.row -->
