            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                 <div class="row">
                    ...
                    Select the <strong> range of date </strong> to check the situation of book!!
                	</div>
                <div class="col-sm-8">
				...
				<form class="form-inline" action="inventory2.php" method="GET">
				<label> Start Date: </label>
				<input type="date" name="datetime" class="form-control">

				<label> End Date: </label>
				<input type="date"  name="datetime1" class="form-control">
				<input type="submit" name="submit" class="btn btn-sm btn-primary" value="Check Book">
