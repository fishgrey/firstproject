            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                 <div class="row">
                    ...
                    Click the <strong> search button </strong> to update or delete the existing products.
                </div>
                <form role="form" action="connection_searchsales.php" method="GET">
                <label>SalesID/Book ID/Book Name</label>
                <input type="text" class="form-control" name="salesID" placeholder="Example: S0001 or B1 or Managerial Economics">
              
                <p> <input type="submit" class="btn btn-sm btn-defaul" value="Search">
                    
                    <a href="sales3.php"class="btn btn-sm btn-success">Create New Sales</a>
