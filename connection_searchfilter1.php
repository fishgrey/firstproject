...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Report <small>Sort By Quantity</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
	  ...
	  $book_quantity1 = $_GET['book_quantity1'];
	  $query = mysql_query("SELECT * FROM book WHERE book_quantity BETWEEN '$book_quantity' AND '$book_quantity1' ORDER BY datetime ASC")or die(mysql_error());   ?>
                 <div class="row">
                    <div class="col-lg-12">
                    <div class="alert alert-info">
                    The books' quantity between<strong> <?php echo "{$book_quantity}" ?> units</strong> to <strong><?php echo "{$book_quantity1}"?> units</strong> .
                </div>
...
<?php mysql_close($con);?>
						<p>
						<a href="report.php" class="btn btn-sm btn-info">Back</a></p>
                	</div>
                </div>
                <!-- /.row -->
