    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <p> <button type="button" class="btn btn-sm btn-defaul">Search</button>
                    <a href="updateproduct.php" class="btn btn-sm btn-primary">Update</a>
                    <a href="addproduct.php"class="btn btn-sm btn-success">Add</a>
