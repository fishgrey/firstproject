        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Report <small>Check Sales Report</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
				...
				<div class="row">
                    ...
                    <strong>Check Sales Report!</strong> Click the following button to check report.
                    </div>
                    <div class="col-sm-5">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                            <h3 class="panel-title">Sort By Total Sales</h3>
                            </div>
                            <div class="panel-body">
                      <form class="form-inline" action="connection_searchfilter2.php" method="GET">
                      <select class="form-control input-sm" name="total_sales">
                      <option>0</option>
                      <option>51</option>
                      <option>101</option>
                      <option>201</option>
                      ...
                      <label>To</label>
                      <select class="form-control input-sm" name="total_sales1">
                      <option>50</option>
                      <option>100</option>
                      <option>200</option>
                      <option>300</option>
                    ...
                    <div class="col-sm-5">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                            <h3 class="panel-title">Sort By Sales Quantity</h3>
                            </div>
                            <div class="panel-body">
                      <form class="form-inline" action="connection_searchfilter3.php" method="GET">
                      ...
                      <label>To</label>
                      <select class="form-control input-sm" name="quantity1">
                      <option>5</option>
                      <option>10</option>
                      <option>15</option>
                      <option>30</option>
