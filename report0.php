        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Report <small>Check Report</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
				...
				<div class="row">
                    ...
                    <strong>Check Report!</strong> Choose book or sales.
                    </div>
                ...
                <div class="row">
                     <div class="col-sm-4">
                        <div class="list-group">
                            <a href="#" class="list-group-item active">Book Report</a>
                            <a href="report.php" class="list-group-item">Sort by Price of Book</a>
                            <a href="report.php" class="list-group-item">Sort by Book Quantity</a>
                             <a href="report2.php" class="list-group-item">Check Book Remain</a>
                            <a href="reportreview1.php" class="list-group-item">Check Book for Restock</a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="list-group">
                            <a href="#" class="list-group-item active">Sales Report</a>
                            <a href="report3.php" class="list-group-item">Sort by Sales Quantity</a>
                            <a href="reportreview.php" class="list-group-item">Total Sales</a>
                            <a href="reportreview3.php" class="list-group-item">Number of Sales</a>
                        </div>
                    </div>
                 </div>
                <!-- /.row -->
